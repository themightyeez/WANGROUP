<!DOCTYPE html>
  <html lang="en">
    <head>
        ...
        <title>Login | WAN Group System</title>
        <link rel="shortcut icon" href="{{ asset('assets/logo wan-group.png') }}">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css" integrity="sha384-B0vP5xmATw1+K9KRQjQERJvTumQW0nPEzvF6L/Z6nronJ3oUOFUFpCjEUQouq2+l" crossorigin="anonymous">

    </head>
    <body>
        <div class="vh-100 vw-100" style="box-sizing: border-box; background-color: #525298">
            <style>
                ...
                .content-3-5 .btn-fill {
                    ...
                    background-image: linear-gradient(rgba(233, 163, 191, 100),
                        rgba(233, 163, 191, 50));
                ...
                .content-3-5 .btn-fill:hover {
                    background-image: linear-gradient(#A1BAE3, #A1BAE3);
                    transition: 0.5s;
                }
            ...
            <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif">
                <div class="position-relative d-none d-lg-block h-100 width-left">
                    <div class="p-2 bd-highlight">
                        <img class="position-absolute img-fluid centered" src="{{ asset('assets/logo wan-group.png') }}" alt="" />  
                    </div>
                </div>
                <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
                    <div class="right mx-lg-0 mx-auto">
                        <div class="align-items-center justify-content-center d-lg-none d-flex">
                            <img class="img-fluid w-50 mb-5" src="{{ asset('assets/logo wan-group.png') }}" alt="" />
                        </div>
                        ...
                        <form style="margin-top: 1.5rem" action="{{ action('AuthController@postLogin') }}" method="post">
                            {{csrf_field()}}
