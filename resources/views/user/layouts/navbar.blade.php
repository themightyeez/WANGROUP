<div class="w-100" style="box-sizing: border-box; background-color: #525298; font-family: 'Poppins', sans-serif" >
    <nav class="navbar-custom navbar navbar-expand-lg navbar-dark px-md-4 py-3 bg-purple">
        <div class="container">
            <a class="navbar-brand" href="{{ action('UserController@dashboard') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link rounded-pill px-md-4" href="{{ action('UserController@dashboard') }}">Dashboard</a>
                    </li>
                </ul>
                <div class="d-flex d-lg-none float-right">
                    <a class="btn btn-account btn-account-kanan" href="{{ action('UserController@account') }}"><i class="fas fa-user-circle"></i> Account</a>
                ...
                <div class="dropdown d-none d-lg-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{ action('UserController@account') }}">Account</a>
