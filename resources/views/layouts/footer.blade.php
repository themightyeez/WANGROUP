<div style="box-sizing: border-box; background-color: #141432">
    <div class="footer-custom container-xxl mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif">
        <div class="border-color info-footer">
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center py-3">
                <div class="d-flex title-font font-medium align-items-center py-3">
                    <a class="mx-1" href="">
