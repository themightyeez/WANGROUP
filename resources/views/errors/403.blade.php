    ...
    <body>
        <div class="container-fluid min-vh-100">
            <div class="empty-4-7 container mx-auto d-flex align-items-center justify-content-center flex-column" style="font-family: 'Poppins', sans-serif;">    
                <img class="img-fluid my-4" style="max-width: 35%" src="{{ asset('assets/error/err403.svg') }}" >
                
                <div class="text-center w-100">
                    <h1 class="title-text text-danger">
                        Opss! Something Restricted
                    </h1>
                    <p class="title-caption">
                        The page you’re looking for has complicated authentication level. <br class="d-sm-block d-none"> We suggest you Back to Homepage.
                    </p>
