    ...
    $(document).ready(function(){
            var dataSet = [
                ...
                [
                    ...
                    @endif
                    "<a class=\"btn btn-edit-monitoring rounded-pill\" data-toggle=\"modal\" data-target=\"#editProduct\" data-id=\"{{ $product->id }}\" data-qty=\"{{ $product->qty }}\" data-notes=\"{{ $product->note }}\"><i class=\"fas fa-edit px-1 py-1\"></i></a>",
                ],
                @endforeach
            ];
