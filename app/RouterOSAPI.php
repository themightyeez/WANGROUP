 ...
 *    New RouterOS API login method fixed by Erick Setiawan (erick.setiawan [at] icloud [dot] com)
 *
...
class RouterosAPI
{
    ...
    var $port      = 8278;  //  Port to connect to (default 8729 for ssl)
    var $ssl       = false; //  Connect using SSL (must enable api-ssl in IP/Services)
    var $timeout   = 30;     //  Connection attempt timeout and data read timeout
    ...
    /**
     * Login to RouterOS (since 6.45.1)
     *
